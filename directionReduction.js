...
var opposite = [];
opposite[0] = ['NORTH','SOUTH'];
opposite[1] = ['SOUTH','NORTH'];
opposite[2] = ['EAST','WEST'];
opposite[3] = ['WEST','EAST'];
...
for(i=0; i<len; i++){
    for(j=0; j<4;j++)
    {
    //console.log(arr[i] + opposite[j]);
    if(arr[i] === opposite[j][0] && arr[i+1] === opposite[j][1])
    {
    arr.splice(i,2);
    console.log(arr);
    i=0;
